...
- **States covered:** loading, empty, error, success
- **Errors & recovery:** the status service is unavailable -> system says so plainly and offers retry; it never implies the domain is clean when it could not check
- **Status:** draft
- **Coverage:** none yet
